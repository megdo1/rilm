...
import { Building2, Users, Plus, TrendingUp, Activity, Zap, BarChart3, UserCog } from 'lucide-react'
import { projectId } from '../utils/supabase/info'
import { toast } from 'sonner@2.0.3'
import { LineChart, Line, AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts'

interface ClientAdminViewProps {
  accessToken: string
}
...
export function ClientAdminView({ accessToken }: ClientAdminViewProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-3xl font-semibold text-gray-900">Administration Client</h2>
          <p className="text-gray-600 mt-1">
            Gérez les organisations et surveillez les performances de votre client
          </p>
        </div>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-semibold text-gray-900 mt-2">45</h3>
                <p className="text-xs text-green-600 mt-2 flex items-center gap-1">
                  <TrendingUp className="w-3 h-3" />
                  +12% ce mois
                </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-semibold text-gray-900 mt-2">127</h3>
                <p className="text-xs text-green-600 mt-2 flex items-center gap-1">
                  <TrendingUp className="w-3 h-3" />
                  +15% ce mois
                </p>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Gérez vos départements et équipes</p>
          </div>
          <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Ajoutez une organisation à votre client
                </DialogDescription>
              </DialogHeader>
